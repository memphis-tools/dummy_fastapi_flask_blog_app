...
def test_get_user_starred_books_without_being_authenticated(client):
    ...
    """
    response = client.get(
        "http://localhost/users/2/starred/",
...
def test_get_unexisting_user_starred_books_being_authenticated(client, access_session):
    ...
    response = client.get(
        "http://localhost/users/55555/starred/",
        headers=headers,
        follow_redirects=True,
    )
    assert response.status_code == 200
...
def test_get_user_starred_books_for_other_user_being_authenticated(client, access_session):
    ...
    response = client.get(
        "http://localhost/users/4/books/1/starred/add/",
        headers=headers,
        follow_redirects=True,
    )
    assert response.status_code == 200
...
def test_get_user_starred_books_for_starred_book_being_authenticated(
    ...
    response = client.get(
        "http://localhost/users/2/books/1/starred/add/",
        headers=headers,
        follow_redirects=True,
    )
    assert response.status_code == 200
...
def test_add_user_starred_books_without_being_authenticated(client, get_flask_csrf_token):
    """
...
def test_add_a_starred_book_for_unexisting_book_being_authenticated(
    ...
    response = client.post(
        "http://localhost/users/2/books/55555/starred/add/",
        headers=headers,
        data=form,
        follow_redirects=True,
    )
...
def test_add_a_starred_book_to_user_being_authenticated(
    ...
    url = "http://localhost/users/2/books/4/starred/add/"
...
def test_delete_starred_book_for_unexisting_user_being_authenticated(
    ...
    response = client.get(
        "/users/55555/books/1/starred/delete/",
        headers=headers,
        follow_redirects=True,
    )
    assert response.status_code == 200
...
def test_delete_starred_book_for_other_user_being_authenticated(
    ...
    response = client.get(
        "/users/3/books/1/starred/delete/",
        headers=headers,
        follow_redirects=True,
    )
    assert response.status_code == 200
...
def test_delete_starred_book_with_unexisting_book_being_authenticated(
    ...
    response = client.post(
        "/users/2/books/55555/starred/delete/",
        headers=headers,
        data=form,
        follow_redirects=True,
    )
...
def test_delete_starred_book_being_authenticated(
    ...
    response = client.post(
        "/users/2/books/3/starred/delete/",
        headers=headers,
        data=form,
        follow_redirects=True,
    )
